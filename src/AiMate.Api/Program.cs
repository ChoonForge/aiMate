...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .WriteTo.File("logs/aiMate-api-.txt", rollingInterval: RollingInterval.Day)
    .CreateLogger();
...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("CanAddOwnKeys", policy =>
        policy.Requirements.Add(new AiMate.Api.Authorization.PermissionRequirement(
...
builder.Services.AddSingleton<Microsoft.AspNetCore.Authorization.IAuthorizationHandler,
    AiMate.Api.Authorization.PermissionHandler>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(options =>
    {
        ...
        options.DocumentTitle = "aiMate API Documentation";
    });
}
